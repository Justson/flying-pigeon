...
public class ClassUtil {
	...
	public static Class<?>[] getValidInterface(Class<?> clazz) {
		...
		for (int i = 0; i < interfaces.length; i++) {
			...
			if (Parcelable.class.isAssignableFrom(anInterface)
					|| Cloneable.class.isAssignableFrom(anInterface)
	...
	static final class ParameterizedTypeImpl implements ParameterizedType {
		...
		public boolean equals(Object other) {
			return other instanceof ParameterizedType && ClassUtil.equals(this, (ParameterizedType) other);
		}
	...
	private static final class GenericArrayTypeImpl implements GenericArrayType {
		...
		public boolean equals(Object o) {
			return o instanceof GenericArrayType
					&& ClassUtil.equals(this, (GenericArrayType) o);
		}
	...
	private static final class WildcardTypeImpl implements WildcardType {
		...
		@Override
		public boolean equals(Object other) {
			return other instanceof WildcardType && ClassUtil.equals(this, (WildcardType) other);
		}
